...
for i in {1..6};
do
  python run_qa.py --model_name_or_path "deepset/roberta-base-squad2" --train_file data/output/hands_train/hands_train_gold_nines_$i\a.json --do_train --version_2_with_negative --output_dir hands/train/roberta_hands_train_gold_$i\a --overwrite_output_dir --max_seq_length 512  2>&1 | tee hands/train/handstrain_$i\a.log
done
